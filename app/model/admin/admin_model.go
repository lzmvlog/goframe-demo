...
// arModel is a active record design model for table admin operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of admin.
	Table = "admin"
	// Model is the model object of admin.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table admin.
	Columns = struct {
		Id         string //   
        AdminName  string //   
        Password   string //
