...
// arModel is a active record design model for table grade operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of grade.
	Table = "grade"
	// Model is the model object of grade.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table grade.
	Columns = struct {
		Id         string //   
        Gradename  string //
	}{
