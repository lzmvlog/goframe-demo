...
// arModel is a active record design model for table student operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of student.
	Table = "student"
	// Model is the model object of student.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table student.
	Columns = struct {
		Id       string //   
        Name     string //   
        Age      string //   
